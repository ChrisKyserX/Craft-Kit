          ...
          "./src/base.js": (
            ...
            (function(module2, exports2, __webpack_require__) {
              ...
              function putObject(params, callback) {
                ...
                needCalcMd5 && self2.logger.debug({
                  cate: "PROCESS",
                  tag: "upload",
              ...
              function allowRetry(err) {
                ...
                if (err) {
                  if (isTimeError && serverDate) {
                    ...
                    canRetry = true;
                    networkError = self2.options.AutoSwitchHost;
                    ...
                    _submitRequest.call(self2, params, function(err2, data) {
                      ...
                      if (err2) {
                        ...
                        self2.logger.error({
                          cate: "PROCESS",
                          tag: "network",
                          msg: "请求失败, err=".concat(JSON.stringify(err2), ", canRetry=").concat(canRetry, ", networkError=").concat(networkError, ", tryTimes=").concat(tryTimes)
                        });
                      }
                      if (err2 && tryTimes < 4 && canRetry) {
                        if (params.headers) {
              ...
              function _submitRequest(params, callback) {
                ...
                var sender = (self2.options.Request || REQUEST)(opt, function(r) {
                  ...
                  var cb = function cb2(err2, data) {
                    TaskId && self2.off("inner-kill-task", _killTask);
                ...
                var _killTask = function killTask(data) {
                  if (data.TaskId === TaskId) {
                    ...
                    self2.off("inner-kill-task", _killTask);
                  }
                };
                TaskId && self2.on("inner-kill-task", _killTask);
              }
              var API_MAP = {
                // Bucket 相关方法
                getService,
          ...
          "./src/cos.js": (
            ...
            (function(module2, exports2, __webpack_require__) {
              ...
              var COS = function COS2(options) {
                var _this$options$LogLeve, _this$options$LogExtr, _this = this;
              ...
              var Logger = (function() {
                ...
                return _createClass(Logger2, [{
                  ...
                  value: function log() {
                    ...
                    var type = arguments.length <= 0 ? void 0 : arguments[0];
                    var _ref = arguments.length <= 1 ? void 0 : arguments[1], _ref$cate = _ref.cate, cate = _ref$cate === void 0 ? "base" : _ref$cate, _ref$tag = _ref.tag, tag = _ref$tag === void 0 ? "base" : _ref$tag, msg = _ref.msg;
                    var logMsg = {
